                ...
                <div class="card shadow mb-12">
                    ...
                    <div class="card-body">
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <div class="form-group">
                                <label for="no_kk">Nama KK <?php echo form_error('no_kk') ?></label>
                            ...
                            <button type="submit" class="btn btn-primary" onclick="return confirm('Anda yakin data sudah benar ?')">Tambah User</button> 
