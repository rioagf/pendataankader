<section class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center features-boxed" style="min-height: 100vh;background: url('assets/img/8.jpg');background-size: cover; background-attachment: fixed;">
    <div class="container" style="max-width: 850px; margin-bottom: 75px;">
        <div class="intro">
            <?php 
        ...
        <div style="background-color: #ffffff !important; padding: 25px; overflow: auto;">
            <table id="table_data" class="table table-striped table-bordered" style="margin-bottom: 10px">
                ...
                <tbody>
                    <?php foreach ($data_warga_data as $data_warga) { ?>
                        <tr>
                            <td><?php echo ++$start ?></td>
                            <td><?php echo $data_warga->no_kk ?></td>
                            <td><?php echo $data_warga->nik ?></td>
                            <td><?php echo $data_warga->nama_lengkap ?></td>
                            <td><?php echo $data_warga->rt ?></td>
                            <td><?php echo $data_warga->status_keluarga ?></td>
                            <td>
                                <a class="btn btn-sm btn-primary" href="<?= site_url('data_warga/read/'.$data_warga->no_kk) ?>"><i class="fa fa-book"></i></a>
                                <!-- <a class="btn btn-sm btn-warning" href="<?= site_url('data_warga/update/'.$data_warga->no_kk) ?>"><i class="fa fa-pencil"></i></a> -->
                                <a class="btn btn-sm btn-danger" href="<?= site_url('data_warga/delete/'.$data_warga->no_kk) ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="container">
            <section class="d-flex justify-content-center" style="width: 100%;">
                <div class="row" style="width: 100%;">
                    ...
                    <div class="col text-center" style="width: 33.3333%;">
                        <a href="<?= base_url('data_warga/create') ?>" style="color: rgb(255,255,255);">
