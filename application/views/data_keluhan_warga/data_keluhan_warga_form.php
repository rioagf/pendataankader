        ...
        <div style="background-color: #ffffff !important; padding: 25px; overflow: auto;">
            <form action="<?php echo $action; ?>" method="post">
             <div class="form-group">
                <label for="varchar">Judul Keluhan <?php echo form_error('judul_keluhan') ?></label>
                <input type="text" class="form-control" name="judul_keluhan" id="judul_keluhan" placeholder="Judul Keluhan" value="<?php echo $judul_keluhan; ?>" />
            </div>
            <div class="form-group">
